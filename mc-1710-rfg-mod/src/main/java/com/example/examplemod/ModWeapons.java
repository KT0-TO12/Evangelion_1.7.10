...
public class ModWeapons {
    ...
    public static final Item.ToolMaterial PROG_KNIFE_MAT = EnumHelper.addToolMaterial("PROG_KNIFE_MAT", 3, 1500, 8.0F, 4.0F, 10);
    ...
    public static final Item.ToolMaterial LANCE_MAT = EnumHelper.addToolMaterial("LANCE_MAT", 4, -1, 10.0F, 20.0F, 15);
